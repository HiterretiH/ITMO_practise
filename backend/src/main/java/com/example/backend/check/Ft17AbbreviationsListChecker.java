 ...
 * оформление списка сокращений и условных обозначений (п. 4.8.4).
...
public final class Ft17AbbreviationsListChecker {
    ...
    public static String formatSectionDiagnostics(List<ParagraphInfo> paragraphs, List<TableInfo> tables) {
        if (paragraphs == null || paragraphs.isEmpty()) {
            return "нет абзацев — раздел «" + CheckSession.ft17().sectionTitle() + "» не искался.";
        }
            ...
            if (endsWithTrailingPunctuation(raw)) {
                ...
                issues.add(
                        ...
                        String.format(
                                ...
                                "обнаружен %s. %s — в конце строки «%s» не должно быть знаков препинания (п. 4.8.4). "
            ...
            for (int c = 0; c < columnCount; c++) {
                ...
                issues.add(
                        ...
                        String.format(
                                ...
                                "обнаружен %s. %s — таблица №%d, строка %d, столбец %d: в конце текста ячейки не должно быть знаков препинания (п. 4.8.4). "
