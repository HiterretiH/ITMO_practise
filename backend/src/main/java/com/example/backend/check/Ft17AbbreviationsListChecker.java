 ...
 * ФТ-17: оформление списка сокращений и условных обозначений (п. 4.8.4).
 ...
 *   <li><b>Вариант 1</b> — элементы столбцом: отдельные абзацы вне таблицы; сокращение и расшифровка разделены тире;

 *       термин с прописной буквы; по левому краю; в конце строки нет знаков препинания.</li>

 *   <li><b>Вариант 2</b> — таблица Word с двумя столбцами (термин | расшифровка); первая строка заполнена;

 *       в остальных строках не должно быть пустых ячеек; в конце текста ячейки — без знаков препинания (как в варианте 1).</li>

 * </ul>

 * Раздел ищется по заголовку уровня 0 «СПИСОК СОКРАЩЕНИЙ И УСЛОВНЫХ ОБОЗНАЧЕНИЙ». Если раздела нет, замечаний нет.

 */

public final class Ft17AbbreviationsListChecker {



    private static final String REQ = "п. 4.8.4 — список сокращений и условных обозначений";
    ...
    /** Знаки препинания в конце строки (п. 4.8.4 — без точки и запятой; расширяем явно). */

    private static final Pattern TRAILING_PUNCTUATION = Pattern.compile("[.,;:!?…]+$");

    /** П. 4.8.4 — в конце строки/ячейки не должно быть знаков препинания. */
    ...
    private Ft17AbbreviationsListChecker() {
    ...
    /**
     * Одна строка для лога: найден ли раздел «СПИСОК СОКРАЩЕНИЙ…», индекс абзаца, граница, какой вариант.
     */
    public static String formatSectionDiagnostics(List<ParagraphInfo> paragraphs, List<TableInfo> tables) {
        ...
        return String.format(
                Locale.ROOT,
                "ФТ-17: раздел найден — абзац заголовка #%d, outlineLevel=%s, текст: «%s»; %s; %s.",
                h,
                ol,
                headPreview,
                rangeDesc,
            ...
            if (al != null && !"LEFT".equalsIgnoreCase(al)) {
                ...
                issues.add(
                        ...
                        String.format(
                                ...
                                "ФТ-17: обнаружен %s. %s — строка «%s» (стр. %s): выравнивание не по левому краю (%s). "
            ...
            if (!dashM.find()) {
                ...
                issues.add(
                        ...
                        String.format(
                                ...
                                "ФТ-17: обнаружен %s. %s — строка «%s»: нет тире между термином и расшифровкой. "
            ...
            if (defPart.isEmpty()) {
                ...
                issues.add(
                        ...
                        String.format(
                                ...
                                "ФТ-17: обнаружен %s. %s — строка «%s»: после тире нет расшифровки. "
            ...
            if (firstLetter < 0) {
                ...
                issues.add(
                        ...
                        String.format(
                                ...
                                "ФТ-17: обнаружен %s. %s — в термине «%s» нет буквы (проверка прописной буквы). "
                ...
                if (Character.isLetter(cp) && !Character.isUpperCase(cp)) {
                    ...
                    issues.add(
                            ...
                            String.format(
                                    ...
                                    "ФТ-17: обнаружен %s. %s — термин «%s» должен начинаться с прописной буквы. "
            ...
            if (endsWithTrailingPunctuation(raw)) {
                ...
                issues.add(
                        ...
                        String.format(
                                ...
                                "ФТ-17: обнаружен %s. %s — в конце строки «%s» не должно быть знаков препинания (п. 4.8.4). "
            ...
            if (cc == null || cc < 2) {
                ...
                issues.add(
                        ...
                        String.format(
                                ...
                                "ФТ-17: обнаружен %s. %s — таблица №%d (начало на стр. %s): нужны два столбца (термин и расшифровка). "
        ...
        if (start < 0 || end > paragraphs.size() || start >= end) {
            ...
            issues.add(
                    ...
                    String.format(
                            ...
                            "ФТ-17: обнаружен %s. %s — таблица №%d: не удалось сопоставить ячейки разбору.",
        ...
        if (rows.isEmpty()) {
            ...
            issues.add(
                    ...
                    String.format(
                            ...
                            "ФТ-17: обнаружен %s. %s — таблица №%d: нет данных по строкам/столбцам (проверьте сохранение как .docx).",
            ...
            if (r == 0) {
                ...
                issues.add(
                        ...
                        String.format(
                                ...
                                "ФТ-17: обнаружен %s. %s — таблица №%d, строка %d (первая): должны быть заполнены термин (столбец 1) и определение (столбец 2); пустые столбцы: %s. "
                ...
                issues.add(
                        ...
                        String.format(
                                ...
                                "ФТ-17: обнаружен %s. %s — таблица №%d, строка %d: пустые столбцы: %s. "
            ...
            for (int c = 0; c < columnCount; c++) {
                ...
                issues.add(
                        ...
                        String.format(
                                ...
                                "ФТ-17: обнаружен %s. %s — таблица №%d, строка %d, столбец %d: в конце текста ячейки не должно быть знаков препинания (п. 4.8.4). "
