 ...
 * ФТ-18: оформление списка терминов и определений (п. 4.9.2).
...
public final class Ft18TermsDefinitionsChecker {
    ...
    public static String formatSectionDiagnostics(List<ParagraphInfo> paragraphs, List<TableInfo> tables) {
        ...
        return String.format(
                Locale.ROOT,
                "ФТ-18: раздел найден — абзац заголовка #%d, outlineLevel=%s, текст: «%s»; %s; %s.",
                h,
                ol,
                headPreview,
                rangeDesc,
            ...
            if (al != null && !"LEFT".equalsIgnoreCase(al)) {
                ...
                issues.add(
                        ...
                        String.format(
                                ...
                                "ФТ-18: обнаружен %s. %s — строка «%s» (стр. %s): выравнивание не по левому краю (%s). "
            ...
            if (!dashM.find()) {
                ...
                issues.add(
                        ...
                        String.format(
                                ...
                                "ФТ-18: обнаружен %s. %s — строка «%s»: нет тире между термином и расшифровкой. "
            ...
            if (defPart.isEmpty()) {
                ...
                issues.add(
                        ...
                        String.format(
                                ...
                                "ФТ-18: обнаружен %s. %s — строка «%s»: после тире нет расшифровки. "
            ...
            if (firstLetter < 0) {
                ...
                issues.add(
                        ...
                        String.format(
                                ...
                                "ФТ-18: обнаружен %s. %s — в термине «%s» нет буквы (проверка прописной буквы). "
                ...
                if (Character.isLetter(cp) && !Character.isUpperCase(cp)) {
                    ...
                    issues.add(
                            ...
                            String.format(
                                    ...
                                    "ФТ-18: обнаружен %s. %s — термин «%s» должен начинаться с прописной буквы. "
            ...
            if (endsWithTrailingPunctuation(raw)) {
                ...
                issues.add(
                        ...
                        String.format(
                                ...
                                "ФТ-18: обнаружен %s. %s — в конце строки «%s» не должно быть знаков препинания (п. 4.9.2). "
            ...
            if (cc == null || cc < 2) {
                ...
                issues.add(
                        ...
                        String.format(
                                ...
                                "ФТ-18: обнаружен %s. %s — таблица №%d (начало на стр. %s): нужны два столбца (термин и расшифровка). "
        ...
        if (start < 0 || end > paragraphs.size() || start >= end) {
            ...
            issues.add(
                    ...
                    String.format(
                            ...
                            "ФТ-18: обнаружен %s. %s — таблица №%d: не удалось сопоставить ячейки разбору.",
        ...
        if (rows.isEmpty()) {
            ...
            issues.add(
                    ...
                    String.format(
                            ...
                            "ФТ-18: обнаружен %s. %s — таблица №%d: нет данных по строкам/столбцам (проверьте сохранение как .docx).",
            ...
            if (r == 0) {
                ...
                issues.add(
                        ...
                        String.format(
                                ...
                                "ФТ-18: обнаружен %s. %s — таблица №%d, строка %d (первая): должны быть заполнены термин (столбец 1) и определение (столбец 2); пустые столбцы: %s. "
                ...
                issues.add(
                        ...
                        String.format(
                                ...
                                "ФТ-18: обнаружен %s. %s — таблица №%d, строка %d: пустые столбцы: %s. "
            ...
            for (int c = 0; c < columnCount; c++) {
                ...
                issues.add(
                        ...
                        String.format(
                                ...
                                "ФТ-18: обнаружен %s. %s — таблица №%d, строка %d, столбец %d: в конце текста ячейки не должно быть знаков препинания (п. 4.9.2). "
